...
public class ConnectionDialog extends JDialog {
    ...
    public ConnectionDialog(final JFrame owner, final WindowListener appWindowListener,
                            final ConnectionParams connectionParams, final ProtocolSettings protocolSettings,
                            final UiSettings uiSettings, final boolean hasJsch, ConnectionsHistory connHistory) {
		super(owner, "New TightVNC Connection");
        this.connectionParams = connectionParams;
		this.hasJsch = hasJsch;
        this.connectionsHistory = connHistory;
        ...
        serverNameCombo.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                ...
                if (item instanceof ConnectionParams) {
                    ...
                    protocolSettings.copySerializedFieldsFrom(connectionsHistory.getProtocolSettings(cp));
                    uiSettings.copyDataFrom(connectionsHistory.getUiSettingsData(cp));
                }
            }
        });
		...
		connectButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				setSshOptions();
                connectionsHistory.reorderConnectionsList(connectionParams, protocolSettings, uiSettings);
		...
		optionsButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				od.initControlsFromSettings(protocolSettings, uiSettings, true);
				od.setVisible(true);
                toFront();
            }
		});
